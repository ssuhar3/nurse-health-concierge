...
function buildPage4_BackgroundCheck(ctx) {
  ...
  const legalText = `I hereby authorize Legacy Senior Advocate to conduct a background investigation as part of my application for a Health Advocate position. This investigation may include, but is not limited to:
...
function buildPage5_HIPAA(ctx) {
  ...
  const legalText = `As a Health Advocate with Legacy Senior Advocate, I understand that I may have access to Protected Health Information (PHI) and other confidential information regarding clients and their families. By signing below, I agree to the following:
...
function buildPage6_ContractorAgreement(ctx) {
  ...
  const sections = [
    ['Scope of Services', 'The Contractor agrees to provide health advocacy services to clients of Legacy Senior Advocate as assigned, including but not limited to care coordination, medical appointment accompaniment, insurance navigation, and family communication support.'],
