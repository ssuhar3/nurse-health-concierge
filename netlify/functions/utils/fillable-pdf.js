...
function drawFooter(page, ctx, pageNum) {
  page.drawText(`Page ${pageNum} of 8  |  Legacy Senior Advocates  |  Confidential`, {
...
function buildPage4_BackgroundCheck(ctx) {
  ...
  const legalText = `I hereby authorize Legacy Senior Advocates to conduct a background investigation as part of my application for a Health Advocate position. This investigation may include, but is not limited to:
...
I release Legacy Senior Advocates and its agents from any liability arising from the collection and use of this information. I understand that any misrepresentation or omission of facts in my application or during the background check process may result in disqualification from consideration or termination of any subsequent engagement.

This authorization remains valid for the duration of my application process and, if engaged, for the duration of my relationship with Legacy Senior Advocates.`;
...
function buildPage5_HIPAA(ctx) {
  ...
  const legalText = `As a Health Advocate with Legacy Senior Advocates, I understand that I may have access to Protected Health Information (PHI) and other confidential information regarding clients and their families. By signing below, I agree to the following:
...
2. Confidentiality: I will maintain strict confidentiality of all client information, medical records, personal data, and any proprietary information belonging to Legacy Senior Advocates.
...
5. Reporting: I will immediately report any known or suspected breach of PHI or confidential information to Legacy Senior Advocates management.
...
function buildPage6_ContractorAgreement(ctx) {
  ...
  const sections = [
    ['Scope of Services', 'The Contractor agrees to provide health advocacy services to clients of Legacy Senior Advocates as assigned, including but not limited to care coordination, medical appointment accompaniment, insurance navigation, and family communication support.'],
    ...
    ['Non-Solicitation', 'During the term of this agreement and for a period of twelve (12) months following termination, the Contractor shall not directly solicit or provide independent services to any client of Legacy Senior Advocates.'],
    ['Confidentiality', 'The Contractor acknowledges and agrees that all client information, business practices, and proprietary methodologies of Legacy Senior Advocates are strictly confidential and shall not be disclosed to any third party.'],
    ['Liability Insurance', 'The Contractor shall maintain professional liability insurance with minimum coverage as specified by Legacy Senior Advocates and shall provide proof of such coverage upon request.'],
    ['Termination', 'Either party may terminate this agreement with fourteen (14) days written notice. Legacy Senior Advocates may terminate immediately in cases of misconduct, breach of confidentiality, or failure to maintain required credentials.'],
  ];
